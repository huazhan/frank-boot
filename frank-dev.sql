/*
 ...
 Source Schema         : frank-dev

 Target Server Type    : MySQL
 Target Server Version : 50728
 File Encoding         : 65001

 Date: 10/01/2021 16:53:35
*/
...
) ENGINE = InnoDB AUTO_INCREMENT = 44 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '部门表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sys_dept
-- ----------------------------
INSERT INTO `sys_dept` VALUES (1, 0, '0,1', '三国集团总部', 0, 'frank', '18777777777', NULL, '1', '2021-01-07 23:23:03', 'sys', '2021-01-10 11:44:51', 'admin', NULL);
INSERT INTO `sys_dept` VALUES (21, 1, '0,1,21', '东吴', 1, 'dongwu', '18777777777', NULL, '1', '2021-01-08 09:22:24', 'anonymousUser', '2021-01-10 11:46:31', 'admin', NULL);
INSERT INTO `sys_dept` VALUES (42, 1, '0,1,42', '西蜀', 2, 'xishu', '18777777777', NULL, '1', '2021-01-09 21:07:26', 'anonymousUser', '2021-01-10 11:46:26', 'admin', NULL);
INSERT INTO `sys_dept` VALUES (43, 1, '0,1,43', '北魏', 3, 'beiwei', '18777777777', NULL, '1', '2021-01-10 11:47:03', 'admin', '2021-01-10 11:47:03', 'admin', NULL);
...
INSERT INTO `sys_menu` VALUES (22, 21, '登录日志', 'log-login-list', '2', '_iframe', '1', '', 'layui-icon layui-icon layui-icon ', 1, '2021-01-09 13:30:20', 'admin', '2021-01-09 13:32:12', 'admin', NULL);
INSERT INTO `sys_menu` VALUES (23, 21, '操作日志', 'log-operation-list', '2', '_iframe', '1', '', 'layui-icon layui-icon layui-icon layui-icon layui-icon ', 2, '2021-01-09 13:31:14', 'admin', '2021-01-09 13:33:37', 'admin', NULL);
...
INSERT INTO `sys_user` VALUES (50, 42, 'test1', '$2a$10$ZCx1GGb87mNfDtQ6u5ClAOc2vjixiEWgIbvcMlVN9.P13eZtdy05.', '测试1', '1', '18777777777', NULL, '1', '2021-01-10 16:15:35', 'admin', '2021-01-10 16:16:00', 'admin', NULL);
...
INSERT INTO `sys_user_role` VALUES (50, 14);
